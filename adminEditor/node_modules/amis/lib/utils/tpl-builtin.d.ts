...
export declare const isPureVariable: (path?: any) => boolean;
export declare const resolveVariableAndFilter: (path?: string | undefined, data?: object, defaultFilter?: string) => any;
