...
//开始编辑页面
export function showHistorycomponent(schema: any, transform?: Function, session: string = 'page') {
    ...
    class SchemaRenderer extends React.Component<SchemaRendererProps> {
        ...
        getEnv() {
            ...
            console.log("no return this.env");
...
export default showHistorycomponent({type: 'page', body: 'It works'});
