...
var QueryBuilder = /** @class */ (function (_super) {
    ...
    QueryBuilder.prototype.render = function () {
        ...
        return (react_1.default.createElement(Group_1.default, { config: this.config, funcs: funcs || this.config.funcs, fields: fields || this.config.fields, value: value, onChange: onChange, classnames: cx, removeable: false, onDragStart: this.handleDragStart, showNot: showNot }));
    };
    var _a, _b, _c;
    tslib_1.__decorate([
        helper_1.autobind,
