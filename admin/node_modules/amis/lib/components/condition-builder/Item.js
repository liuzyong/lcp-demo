...
var ConditionItem = /** @class */ (function (_super) {
    ...
    ConditionItem.prototype.renderLeft = function () {
        ...
        return (react_1.default.createElement(Expression_1.default, { funcs: funcs, value: value.left, onChange: this.handleLeftChange, fields: fields, defaultType: "field", allowedTypes: (config.valueTypes || ['field', 'func']).filter(function (type) { return type === 'field' || type === 'func'; }) }));
    };
    ...
    ConditionItem.prototype.renderRightWidgets = function (type, op) {
        ...
        if (op === 'is_empty' || op === 'is_not_empty') {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(Expression_1.default, { funcs: funcs, valueField: field, value: (_b = value.right) === null || _b === void 0 ? void 0 : _b[0], onChange: this.handleRightSubChange.bind(this, 0), fields: fields, defaultType: "value", allowedTypes: (field === null || field === void 0 ? void 0 : field.valueTypes) ||
                        config.valueTypes || ['value', 'field', 'func', 'raw'] }),
                react_1.default.createElement("span", { className: cx('CBSeprator') }, "~"),
                react_1.default.createElement(Expression_1.default, { funcs: funcs, valueField: field, value: (_c = value.right) === null || _c === void 0 ? void 0 : _c[1], onChange: this.handleRightSubChange.bind(this, 1), fields: fields, defaultType: "value", allowedTypes: (field === null || field === void 0 ? void 0 : field.valueTypes) ||
                        config.valueTypes || ['value', 'field', 'func', 'raw'] })));
        }
        return (react_1.default.createElement(Expression_1.default, { op: op, funcs: funcs, valueField: field, value: value.right, onChange: this.handleRightChange, fields: fields, defaultType: "value", allowedTypes: (field === null || field === void 0 ? void 0 : field.valueTypes) ||
                config.valueTypes || ['value', 'field', 'func', 'raw'] }));
    };
