 ...
 */
import { render, Renderer, getRendererByName, resolveRenderer, filterSchema, clearStoresCache, updateEnv } from './factory';
import { wrapFetcher, buildApi } from './utils/api';
import { filter, reigsterTplEnginer, evalExpression, evalJS, setCustomEvalJs, setCustomEvalExpression } from './utils/tpl';
...
export { render, clearStoresCache, updateEnv, Renderer, RegisterStore, FormItem, OptionsControl, wrapFetcher, buildApi, filter, utils, resizeSensor, registerFilter, reigsterTplEnginer, evalExpression, evalJS, setCustomEvalJs, setCustomEvalExpression, addRule, str2rules, normalizeOptions, getRendererByName, resolveRenderer, filterSchema, filterDate, relativeValueRe, resolveVariable, resolveVariableAndFilter, setIconVendor, Icon, registerIcon, Scoped, ScopedContext, validate, validateObject, setDefaultTheme, theme, getTheme, classPrefix, getClassPrefix, classnames, getDefaultLocale, setDefaultLocale, registerLocale, makeTranslator };
