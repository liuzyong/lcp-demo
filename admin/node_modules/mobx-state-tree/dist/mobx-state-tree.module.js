import { isComputedProp, isObservableProp, action, computed, createAtom, reaction, _allowStateChangesInsideComputed, runInAction, values, observable, isObservableArray, $mobx, getAtom, _interceptReads, intercept, ObservableMap, observe, _getAdministration, set } from 'mobx';
...
function getPropertyMembers$$1(typeOrNode) {
    ...
    if (process.env.NODE_ENV !== "production") {
        if (!isModelType$$1(type))
            fail("expected a model type, but got " + type + " instead.");
    }
    return {
        name: type.name,
        ...
        var invokeHandler = function () {
            ...
            if (process.env.NODE_ENV !== "production") {
                if (!nextInvoked && !abortInvoked) {
                    var node2 = getStateTreeNode$$1(call.tree);
                    fail("Neither the next() nor the abort() callback within the middleware " + handler.name + " for the action: \"" + call.name + "\" on the node: " + node2.type.name + " was invoked.");
                }
                if (nextInvoked && abortInvoked) {
                    var node2 = getStateTreeNode$$1(call.tree);
                    fail("The next() and abort() callback within the middleware " + handler.name + " for the action: \"" + call.name + "\" on the node: " + node2.type.name + " were invoked.");
                }
            }
            return result;
        };
...
function optional$$1(type, defaultValueOrFunction) {
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        if (typeof defaultValueOrFunction !== "function") {
            typecheckInternal$$1(type, defaultValueOrFunction);
        }
    }
...
export { types, typecheck$$1 as typecheck, escapeJsonPath$$1 as escapeJsonPath, unescapeJsonPath$$1 as unescapeJsonPath, joinJsonPath$$1 as joinJsonPath, splitJsonPath$$1 as splitJsonPath, decorate$$1 as decorate, addMiddleware$$1 as addMiddleware, process$$1 as process, isStateTreeNode$$1 as isStateTreeNode, flow, applyAction$$1 as applyAction, onAction$$1 as onAction, recordActions$$1 as recordActions, createActionTrackingMiddleware, setLivelynessChecking$$1 as setLivelynessChecking, getType$$1 as getType, getChildType$$1 as getChildType, onPatch$$1 as onPatch, onSnapshot$$1 as onSnapshot, applyPatch$$1 as applyPatch, recordPatches$$1 as recordPatches, protect$$1 as protect, unprotect$$1 as unprotect, isProtected$$1 as isProtected, applySnapshot$$1 as applySnapshot, getSnapshot$$1 as getSnapshot, hasParent$$1 as hasParent, getParent$$1 as getParent, hasParentOfType$$1 as hasParentOfType, getParentOfType$$1 as getParentOfType, getRoot$$1 as getRoot, getPath$$1 as getPath, getPathParts$$1 as getPathParts, isRoot$$1 as isRoot, resolvePath$$1 as resolvePath, resolveIdentifier$$1 as resolveIdentifier, getIdentifier$$1 as getIdentifier, tryResolve$$1 as tryResolve, getRelativePath$$1 as getRelativePath, clone$$1 as clone, detach$$1 as detach, destroy$$1 as destroy, isAlive$$1 as isAlive, addDisposer$$1 as addDisposer, getEnv$$1 as getEnv, walk$$1 as walk, getMembers$$1 as getMembers, getPropertyMembers$$1 as getPropertyMembers, cast$$1 as cast, isType$$1 as isType, isArrayType$$1 as isArrayType, isFrozenType$$1 as isFrozenType, isIdentifierType$$1 as isIdentifierType, isLateType$$1 as isLateType, isLiteralType$$1 as isLiteralType, isMapType$$1 as isMapType, isModelType$$1 as isModelType, isOptionalType$$1 as isOptionalType, isPrimitiveType$$1 as isPrimitiveType, isReferenceType$$1 as isReferenceType, isRefinementType$$1 as isRefinementType, isUnionType$$1 as isUnionType };
