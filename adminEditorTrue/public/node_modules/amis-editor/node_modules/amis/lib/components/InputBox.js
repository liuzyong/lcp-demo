define('node_modules/amis-editor/node_modules/amis/lib/components/InputBox', function(require, exports, module) {
  ...
  var InputBox = /** @class */ (function (_super) {
      ...
      InputBox.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx('InputBox', className, isFocused ? 'is-focused' : '', disabled ? 'is-disabled' : '', hasError ? 'is-error' : '', rest.onClick ? 'is-clickable' : '') },
              result,
              react_1.default.createElement(Input_1.default, tslib_1.__assign({}, rest, { value: value || '', onChange: this.handleChange, placeholder: placeholder, onFocus: this.handleFocus, onBlur: this.handleBlur })),
              children,
