define('node_modules/amis-editor/node_modules/amis/lib/components/DateRangePicker', function(require, exports, module) {
  ...
  var Calendar_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/calendar/Calendar"));
  ...
  var DateRangePicker = /** @class */ (function (_super) {
      ...
      DateRangePicker.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { tabIndex: 0, onKeyPress: this.handleKeyPress, onFocus: this.handleFocus, onBlur: this.handleBlur, className: classnames_1.default(ns + "DateRangePicker", {
              ...
              arr.length ? (react_1.default.createElement("span", { className: ns + "DateRangePicker-value" }, arr.join(__(' 至 ')))) : (react_1.default.createElement("span", { className: ns + "DateRangePicker-placeholder" }, __(placeholder))),
                      ...
                      react_1.default.createElement("div", { className: ns + "DateRangePicker-wrap" },
                          ...
                          react_1.default.createElement("div", { key: "button", className: ns + "DateRangePicker-actions" },
                              react_1.default.createElement("a", { className: classnames_1.default('rdtBtn rdtBtnConfirm', {
                                  ...
                                  }), onClick: this.confirm }, __('确认')),
                              react_1.default.createElement("a", { className: "rdtBtn rdtBtnCancel", onClick: this.close }, __('取消'))))))) : null));
      };
