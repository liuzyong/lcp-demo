define('node_modules/amis-editor/node_modules/amis/lib/components/AssociatedCheckboxes', function(require, exports, module) {
  ...
  var Select_1 = require("node_modules/amis-editor/node_modules/amis/lib/components/Select");
  var helper_1 = require("node_modules/amis-editor/node_modules/amis/lib/utils/helper");
  var ListRadios_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/ListRadios"));
  ...
  var TreeRadios_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/TreeRadios"));
  ...
  var AssociatedCheckboxes = /** @class */ (function (_super) {
      ...
      AssociatedCheckboxes.prototype.render = function () {
          var _a = this.props, cx = _a.classnames, className = _a.className, leftOptions = _a.leftOptions, options = _a.options, option2value = _a.option2value, rightMode = _a.rightMode, onChange = _a.onChange, columns = _a.columns, value = _a.value, leftMode = _a.leftMode, cellRender = _a.cellRender;
          ...
          return (react_1.default.createElement("div", { className: cx('AssociatedCheckboxes', className) },
              ...
              react_1.default.createElement("div", { className: cx('AssociatedCheckboxes-right') }, this.state.leftValue ? (selectdOption ? (selectdOption.defer && !selectdOption.loaded ? (react_1.default.createElement("div", { className: cx('AssociatedCheckboxes-box') },
                  ...
                  selectdOption.loading ? (react_1.default.createElement("p", null, __('加载中'))) : (react_1.default.createElement("p", null, __('点击刷新重新加载'))))) : rightMode === 'table' ? (react_1.default.createElement(TableCheckboxes_1.default, { columns: columns, value: value, options: selectdOption.children || [], onChange: onChange, option2value: option2value, cellRender: cellRender })) : rightMode === 'tree' ? (react_1.default.createElement(TreeCheckboxes_1.default, { value: value, options: selectdOption.children || [], onChange: onChange, option2value: option2value })) : rightMode === 'chained' ? (react_1.default.createElement(ChainedCheckboxes_1.default, { value: value, options: selectdOption.children || [], onChange: onChange, option2value: option2value })) : (react_1.default.createElement(ListCheckboxes_1.default, { value: value, options: selectdOption.children || [], onChange: onChange, option2value: option2value }))) : (react_1.default.createElement("div", { className: cx('AssociatedCheckboxes-box') }, __('配置错误，选项无法与左侧选项对应')))) : (react_1.default.createElement("div", { className: cx('AssociatedCheckboxes-box') }, __('请先选择左侧数据'))))));
      };
      var _a, _b;
      tslib_1.__decorate([
          helper_1.autobind,
