define('node_modules/amis-editor/node_modules/amis/lib/components/SearchBox', function(require, exports, module) {
  ...
  var SearchBox = /** @class */ (function (_super) {
      ...
      SearchBox.prototype.handleChange = function (e) {
          var _a = this.props, onChange = _a.onChange, onSearch = _a.onSearch;
          onChange === null || onChange === void 0 ? void 0 : onChange(e.currentTarget.value);
          onSearch === null || onSearch === void 0 ? void 0 : onSearch(e.currentTarget.value);
      };
