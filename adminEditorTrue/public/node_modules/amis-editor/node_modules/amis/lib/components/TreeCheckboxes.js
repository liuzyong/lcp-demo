define('node_modules/amis-editor/node_modules/amis/lib/components/TreeCheckboxes', function(require, exports, module) {
  ...
  var TreeCheckboxes = /** @class */ (function (_super) {
      ...
      TreeCheckboxes.prototype.toggleOption = function (option) {
          var _a = this.props, value = _a.value, onChange = _a.onChange, option2value = _a.option2value, options = _a.options, onDeferLoad = _a.onDeferLoad;
          if (option.disabled) {
              return;
          }
