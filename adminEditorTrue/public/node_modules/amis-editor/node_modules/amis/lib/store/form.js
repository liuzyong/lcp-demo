define('node_modules/amis-editor/node_modules/amis/lib/store/form', function(require, exports, module) {
  ...
  var errors_1 = require("node_modules/amis-editor/node_modules/amis/lib/utils/errors");
          ...
          return tslib_1.__generator(this, function (_a) {
              switch (_a.label) {
                  ...
                  case 2:
                      valid = _a.sent();
                      if (!valid) {
                          msg = failedMessage !== null && failedMessage !== void 0 ? failedMessage : self.__('表单验证失败，请仔细检查');
                          msg && mobx_state_tree_1.getRoot(self).notify('error', msg);
