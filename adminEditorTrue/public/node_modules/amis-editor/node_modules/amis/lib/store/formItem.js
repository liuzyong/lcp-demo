define('node_modules/amis-editor/node_modules/amis/lib/store/formItem', function(require, exports, module) {
  ...
  var validations_1 = require("node_modules/amis-editor/node_modules/amis/lib/utils/validations");
  var combo_1 = require("node_modules/amis-editor/node_modules/amis/lib/store/combo");
  ...
  var helper_2 = require("node_modules/amis-editor/node_modules/amis/lib/utils/helper");
          ...
          return tslib_1.__generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      ...
                      self.loading = true;
                      return [4 /*yield*/, mobx_state_tree_1.getRoot(self).fetcher(api, data, tslib_1.__assign({ autoAppend: false, cancelExecutor: function (executor) { return (loadCancel = executor); } }, config))];
                  case 1:
                      json = _a.sent();
                      loadCancel = null;
                      result = null;
                      if (!json.ok) {
                          setErrorFlag !== false &&
                              setError(self.__('加载选项失败，原因：{{reason}}', {
          ...
          if (parentStore && parentStore.storeType === combo_1.ComboStore.name) {
              ...
              group &&
                  group.items.forEach(function (item) {
                      if (self !== item) {
                          options_1.push.apply(options_1, item.selectedOptions.map(function (item) { return item && item.value; }));
                      }
                  });
              if (filteredOptions.length) {
                  filteredOptions = filteredOptions.filter(function (option) { return !~options_1.indexOf(option.value); });
              }
          }
