define('node_modules/amis-editor/node_modules/amis/lib/renderers/IFrame', function(require, exports, module) {
  ...
  var IFrame = /** @class */ (function (_super) {
      ...
      IFrame.prototype.onMessage = function (e) {
          var _a = this.props, events = _a.events, onAction = _a.onAction, data = _a.data;
          if (!e.data || e.data === '' || !events) {
              return;
          }
          var _b = e.data.type.split(':'), prefix = _b[0], type = _b[1];
          if (prefix !== 'amis' || !type) {
              return;
          }
      ...
      IFrame.prototype.receive = function (values) {
          ...
          if (src) {
              ...
              this.postMessage('receive', helper_1.createObject(data, values));
          }
      };
      IFrame.prototype.postMessage = function (type, data) {
          var _a;
          (_a = this.IFrameRef.current.contentWindow) === null || _a === void 0 ? void 0 : _a.postMessage({
              type: "amis:" + type,
              data: data
          }, '*');
      };
      IFrame.prototype.render = function () {
          ...
          return (react_1.default.createElement("iframe", { className: className, frameBorder: frameBorder, style: style, ref: this.IFrameRef, onLoad: this.onLoad, src: src ? api_1.buildApi(src, data).url : undefined }));
      };
      var _a;
