define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/Transfer', function(require, exports, module) {
  ...
  var Options_2 = require("node_modules/amis-editor/node_modules/amis/lib/renderers/Form/Options");
  ...
  var BaseTransferRenderer = /** @class */ (function (_super) {
                      ...
                      case 2:
                          ...
                          return [2 /*return*/, result.map(function (item) {
                                  ...
                                  if (Array.isArray(options)) {
                                      resolved = find_1.default(options, Select_1.optionValueCompare(item[valueField || 'value'], valueField));
                                  }
      ...
      BaseTransferRenderer.prototype.render = function () {
          var _a = this.props, className = _a.className, cx = _a.classnames, options = _a.options, selectedOptions = _a.selectedOptions, showArrow = _a.showArrow, sortable = _a.sortable, selectMode = _a.selectMode, columns = _a.columns, loading = _a.loading, searchable = _a.searchable, searchResultMode = _a.searchResultMode, deferLoad = _a.deferLoad, leftOptions = _a.leftOptions, leftMode = _a.leftMode, rightMode = _a.rightMode;
          return (react_1.default.createElement("div", { className: cx('TransferControl', className) },
              react_1.default.createElement(Transfer_1.default, { value: selectedOptions, options: options, onChange: this.handleChange, option2value: this.option2value, sortable: sortable, showArrow: showArrow, selectMode: selectMode, searchResultMode: searchResultMode, columns: columns, onSearch: searchable ? this.handleSearch : undefined, onDeferLoad: deferLoad, leftOptions: leftOptions, leftMode: leftMode, rightMode: rightMode, cellRender: this.renderCell }),
