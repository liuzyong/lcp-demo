define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/List', function(require, exports, module) {
              ...
              body = (react_1.default.createElement("div", { className: cx('ListControl-items') }, options.map(function (option, key) { return (react_1.default.createElement("div", { key: key, className: cx("ListControl-item", itemClassName, {
                  ...
                  : option.body
                      ...
                      : [
                          ...
                          option[labelField || 'label'] ? (react_1.default.createElement("div", { key: "label", className: cx('ListControl-itemLabel') }, option[labelField || 'label'])) : null
