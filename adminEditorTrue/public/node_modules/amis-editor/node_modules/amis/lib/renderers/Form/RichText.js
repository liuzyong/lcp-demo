define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/RichText', function(require, exports, module) {
  ...
  function loadRichText(type) {
      ...
      return function () {
          return new Promise(function (resolve) {
              return type === 'tinymce'
                  ? require(['node_modules/amis-editor/node_modules/amis/lib/components/Tinymce'], function (component) {
                      return resolve(component.default);
                  })
                  : require(['node_modules/amis-editor/node_modules/amis/lib/components/RichText'], function (component) {
                      return resolve(component.default);
                  });
          });
      };
  ...
  var RichTextControl = /** @class */ (function (_super) {
      ...
      RichTextControl.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: classnames_1.default(ns + "RichTextControl", className, {
              ...
              react_1.default.createElement(LazyComponent_1.default, { getComponent: loadRichText(finnalVendor), model: value, onModelChange: disabled ? helper_1.noop : onChange, onFocus: this.handleFocus, onBlur: this.handleBlur, config: this.config, disabled: disabled, locale: locale, translate: translate })));
      };
