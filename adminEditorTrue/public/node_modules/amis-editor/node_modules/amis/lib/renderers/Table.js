define('node_modules/amis-editor/node_modules/amis/lib/renderers/Table', function(require, exports, module) {

  "use strict";
  Object.defineProperty(exports, "__esModule", { value: true });
  exports.FieldRenderer = exports.TableCellRenderer = exports.TableCell = exports.HeadCellFilterDropDown = exports.HeadCellSearchDropDown = exports.TableRenderer = void 0;
  ...
  var DropDownButton_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/renderers/DropDownButton"));
  var Checkbox_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/Checkbox"));
  var Button_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/Button"));
  var table_1 = require("node_modules/amis-editor/node_modules/amis/lib/store/table");
  var mobx_react_1 = require("node_modules/amis-editor/node_modules/mobx-react/dist/index");
  ...
  var QuickEdit_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/renderers/QuickEdit"));
  var PopOver_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/PopOver"));
  var Copyable_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/renderers/Copyable"));
  var sortablejs_1 = tslib_1.__importDefault(require("node_modules/sortablejs/Sortable"));
  var resize_sensor_1 = require("node_modules/amis-editor/node_modules/amis/lib/utils/resize-sensor");
  var find_1 = tslib_1.__importDefault(require("node_modules/lodash/find"));
  var Overlay_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/components/Overlay"));
  var PopOver_2 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/renderers/PopOver"));
  ...
  var HeadCellSearchDropDown = /** @class */ (function (_super) {
      ...
      HeadCellSearchDropDown.prototype.handleReset = function () {
          ...
          this.formItems.forEach(function (key) { return (values[key] = undefined); });
      ...
      HeadCellSearchDropDown.prototype.render = function () {
          ...
          return (react_1.default.createElement("span", { className: classnames_1.default(ns + "TableCell-searchBtn", isActive ? 'is-active' : '') },
              ...
              this.state.isOpened ? (react_1.default.createElement(Overlay_1.default, { container: popOverContainer || (function () { return react_dom_1.findDOMNode(_this); }), placement: "left-bottom-left-top right-bottom-right-top", target: popOverContainer ? function () { return react_dom_1.findDOMNode(_this).parentNode; } : null, show: true },
                  react_1.default.createElement(PopOver_1.default, { classPrefix: ns, onHide: this.close, className: classnames_1.default(ns + "TableCell-searchPopOver", searchable.className), overlay: true }, render('quick-search-form', formSchema, {
  ...
  var HeadCellFilterDropDown = /** @class */ (function (_super) {
      ...
      HeadCellFilterDropDown.prototype.render = function () {
          ...
          return (react_1.default.createElement("span", { className: cx(ns + "TableCell-filterBtn", data[name] ? 'is-active' : '') },
              react_1.default.createElement("span", { onClick: this.open },
