define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/Image', function(require, exports, module) {
  ...
  var react_cropper_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/react-cropper/dist/react-cropper"));
  var react_dropzone_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/react-dropzone/dist/index"));
  ...
  var File_1 = require("node_modules/amis-editor/node_modules/amis/lib/renderers/Form/File");
  var Image_1 = tslib_1.__importDefault(require("node_modules/amis-editor/node_modules/amis/lib/renderers/Image"));
      ...
      ImageControl.prototype.addFiles = function (files) {
          ...
          [].slice.call(files, 0, allowed).forEach(function (file) {
              if (maxSize && file.size > maxSize) {
                  alert(__('您选择的文件 {{filename}} 大小为 {{actualSize}} 超出了最大为 {{maxSize}} 的限制，请重新选择。', {
                      filename: file.name,
