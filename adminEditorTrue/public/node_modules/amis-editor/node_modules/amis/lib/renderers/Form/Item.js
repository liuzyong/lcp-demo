define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/Item', function(require, exports, module) {
          ...
          return (react_1.default.createElement("div", { className: cx("Form-item Form-item--horizontal", className, (_a = {},
              ...
              react_1.default.createElement("div", { className: cx("Form-value", (_c = {},
                  ...
                  hint && model && model.isFocused
                      ...
                      : null,
                  model && !model.valid && showErrorMsg !== false ? (react_1.default.createElement("ul", { className: cx("Form-feedback") }, model.errors.map(function (msg, key) { return (react_1.default.createElement("li", { key: key }, msg)); }))) : null,
