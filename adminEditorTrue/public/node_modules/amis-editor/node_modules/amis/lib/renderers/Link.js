define('node_modules/amis-editor/node_modules/amis/lib/renderers/Link', function(require, exports, module) {
  ...
  var LinkField = /** @class */ (function (_super) {
      ...
      LinkField.prototype.render = function () {
          ...
          return (react_1.default.createElement("a", { href: finnalHref || value, target: htmlTarget || (blank ? '_blank' : '_self'), className: cx('Link', className) }, body ? render('body', body) : finnalHref || value || __('链接')));
      };
