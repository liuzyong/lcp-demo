define('node_modules/amis-editor/node_modules/amis/lib/renderers/Form/Control', function(require, exports, module) {
      ...
      FormControl.prototype.controlRef = function (control) {
          ...
          if (control && control.validate && this.model) {
              ...
              this.hook = function () {
                  ...
                  return validate_1(form.data, formItem_1.value, formItem_1.name).then(function (ret) {
                      if ((typeof ret === 'string' || Array.isArray(ret)) && ret) {
