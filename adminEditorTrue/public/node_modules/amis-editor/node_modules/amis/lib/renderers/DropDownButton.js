define('node_modules/amis-editor/node_modules/amis/lib/renderers/DropDownButton', function(require, exports, module) {
  ...
  var DropDownButton = /** @class */ (function (_super) {
      ...
      DropDownButton.prototype.render = function () {
          var _a = this.props, block = _a.block, disabled = _a.disabled, btnDisabled = _a.btnDisabled, size = _a.size, label = _a.label, level = _a.level, primary = _a.primary, className = _a.className, cx = _a.classnames, align = _a.align, iconOnly = _a.iconOnly, icon = _a.icon, data = _a.data;
