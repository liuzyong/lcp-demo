define('node_modules/amis/lib/components/ResultList', function(require, exports, module) {
  ...
  var ResultList = /** @class */ (function (_super) {
      ...
      ResultList.prototype.handleRemove = function (e) {
          ...
          var _b = this.props, value = _b.value, onChange = _b.onChange;
          if (!Array.isArray(value)) {
              return;
          }
          var newValue = value.concat();
          newValue.splice(index, 1);
          (_a = onChange) === null || _a === void 0 ? void 0 : _a(newValue);
      };
      ...
      ResultList.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx('Selections', className) },
              ...
              Array.isArray(value) && value.length ? (react_1.default.createElement("div", { className: cx('Selections-items') }, value.map(function (option, index) {
                  var _a;
                  return (react_1.default.createElement("div", { className: cx('Selections-item', itemClassName, (_a = option) === null || _a === void 0 ? void 0 : _a.className), key: index },
