define('node_modules/amis/lib/components/TreeCheckboxes', function(require, exports, module) {
  ...
  var TreeCheckboxes = /** @class */ (function (_super) {
      ...
      TreeCheckboxes.prototype.toggleOption = function (option) {
          var _a;
          var _b = this.props, value = _b.value, onChange = _b.onChange, option2value = _b.option2value, options = _b.options, onDeferLoad = _b.onDeferLoad;
          if (option.disabled) {
              return;
          }
