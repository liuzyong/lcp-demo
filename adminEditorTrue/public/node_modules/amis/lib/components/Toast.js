define('node_modules/amis/lib/components/Toast', function(require, exports, module) {
  ...
  var ToastComponent = /** @class */ (function (_super) {
      ...
      ToastComponent.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx("Toast-wrap Toast-wrap--" + position.replace(/\-(\w)/g, function (_, l) {
              ...
              var _a, _b;
              return (react_1.default.createElement(ToastMessage, { classnames: cx, key: item.id, title: item.title, body: item.body, level: item.level || 'info', timeout: (_a = item.timeout, (_a !== null && _a !== void 0 ? _a : timeout)), closeButton: (_b = item.closeButton, (_b !== null && _b !== void 0 ? _b : closeButton)), onDismiss: _this.handleDismissed.bind(_this, index), translate: translate, showIcon: showIcon }));
          })));
      };
