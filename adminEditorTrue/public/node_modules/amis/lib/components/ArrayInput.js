define('node_modules/amis/lib/components/ArrayInput', function(require, exports, module) {
  ...
  var ArrayInput = /** @class */ (function (_super) {
      ...
      ArrayInput.prototype.handleAdd = function () {
          var _a;
          var _b = this.props, value = _b.value, onChange = _b.onChange, itemInitalValue = _b.itemInitalValue;
          var newValue = Array.isArray(value) ? value.concat() : [];
