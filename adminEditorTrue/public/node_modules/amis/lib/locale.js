define('node_modules/amis/lib/locale', function(require, exports, module) {
  ...
  function makeTranslator(locale) {
      ...
      var fn = function (str) {
          ...
          return format.apply(void 0, tslib_1.__spreadArrays([((_a = dict) === null || _a === void 0 ? void 0 : _a[str]) || str], args));
      };
