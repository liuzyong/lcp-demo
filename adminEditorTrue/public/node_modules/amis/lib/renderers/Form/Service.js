define('node_modules/amis/lib/renderers/Form/Service', function(require, exports, module) {
  ...
  var Service_1 = tslib_1.__importDefault(require("node_modules/amis/lib/renderers/Service"));
  ...
  var ServiceRenderer = /** @class */ (function (_super) {
      ...
      ServiceRenderer.prototype.afterDataFetch = function (payload) {
          ...
          if (formStore && this.isFormMode()) {
              var keys = helper_1.isObject((_a = payload) === null || _a === void 0 ? void 0 : _a.data) ? Object.keys(payload.data) : [];
              if (keys.length) {
