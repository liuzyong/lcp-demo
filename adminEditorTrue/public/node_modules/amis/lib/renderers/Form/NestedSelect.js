define('node_modules/amis/lib/renderers/Form/NestedSelect', function(require, exports, module) {
  ...
  var Input_1 = tslib_1.__importDefault(require("node_modules/amis/lib/components/Input"));
  ...
  var NestedSelectControl = /** @class */ (function (_super) {
      ...
      NestedSelectControl.prototype.handleCheck = function (option, index) {
          var _a = this.props, onChange = _a.onChange, selectedOptions = _a.selectedOptions, joinValues = _a.joinValues, valueField = _a.valueField, delimiter = _a.delimiter, extractValue = _a.extractValue, withChildren = _a.withChildren, cascade = _a.cascade, multiple = _a.multiple;
          ...
          if (Array.isArray(option)) {
              ...
              if (cascade) {
                  ...
                  var fn = option.every(function (opt) { return !!~items.findIndex(function (item) { return item.value === opt.value; }); })
                      ? xorBy_1.default
                      : unionBy_1.default;
                  ...
                  newValue = items.filter(function (item) {
                      return !~helper_1.flattenTree([option], function (i) { return i.value; }).indexOf(item.value);
                  });
                  !~items.map(function (item) { return item.value; }).indexOf(option.value) &&
      ...
      NestedSelectControl.prototype.allChecked = function (options) {
          ...
          return options.every(function (option) {
              ...
              return selectedOptions.some(function (selectedOption) { return selectedOption.value == option.value; });
          });
      };
      ...
      NestedSelectControl.prototype.renderOptions = function () {
          var _this = this;
          var _a = this.props, multiple = _a.multiple, selectedOptions = _a.selectedOptions, cx = _a.classnames, value = _a.value, options = _a.options, disabled = _a.disabled, searchable = _a.searchable, searchPromptText = _a.searchPromptText, __ = _a.translate;
          var stack = this.state.stack;
          ...
          return (react_1.default.createElement(react_1.default.Fragment, null, stack.map(function (options, index) { return (react_1.default.createElement("div", { key: index, className: cx('NestedSelect-menu') },
              ...
              multiple && index === 0 ? (react_1.default.createElement("div", { className: cx('NestedSelect-option', 'checkall'), onMouseEnter: _this.onMouseEnterAll },
                  react_1.default.createElement(Checkbox_1.default, { onChange: _this.handleCheck.bind(_this, options), checked: partialChecked, partial: partialChecked && !allChecked }, "\u5168\u9009"))) : null,
              options.map(function (option, idx) {
                  ...
                  return (react_1.default.createElement("div", { key: idx, className: cx('NestedSelect-option', {
                      ...
                      multiple ? (react_1.default.createElement(Checkbox_1.default, { className: cx('NestedSelect-optionLabel'), onChange: _this.handleCheck.bind(_this, option, index), trueValue: option.value, checked: selfChecked, disabled: nodeDisabled }, option.label)) : (react_1.default.createElement("div", { className: cx('NestedSelect-optionLabel') },
      ...
      NestedSelectControl.prototype.onMouseEnter = function (option, index, e) {
          var stack = this.state.stack;
          var _a = this.props, cascade = _a.cascade, multiple = _a.multiple, selectedOptions = _a.selectedOptions;
          index = index + 1;
