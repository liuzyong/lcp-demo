define('node_modules/amis/lib/renderers/Form/Picker', function(require, exports, module) {
  ...
  var PickerControl = /** @class */ (function (_super) {
      ...
      PickerControl.prototype.render = function () {
          var _a = this.props, className = _a.className, cx = _a.classnames, disabled = _a.disabled, render = _a.render, modalMode = _a.modalMode, source = _a.source, size = _a.size, env = _a.env, clearable = _a.clearable, multiple = _a.multiple, placeholder = _a.placeholder, embed = _a.embed, value = _a.value, selectedOptions = _a.selectedOptions, __ = _a.translate;
