define('node_modules/amis/lib/renderers/Form/TreeSelect', function(require, exports, module) {
  ...
  var Tree_1 = tslib_1.__importDefault(require("node_modules/amis/lib/components/Tree"));
  // @ts-ignore
  ...
  var ResultBox_1 = tslib_1.__importDefault(require("node_modules/amis/lib/components/ResultBox"));
  ...
  var TreeSelectControl = /** @class */ (function (_super) {
      ...
      TreeSelectControl.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { ref: this.container, className: cx("TreeSelectControl", className) },
              react_1.default.createElement(ResultBox_1.default, { disabled: disabled, ref: this.target, placeholder: __(placeholder || '空'), className: cx("TreeSelect", {
