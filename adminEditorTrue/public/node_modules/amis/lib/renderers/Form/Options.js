define('node_modules/amis/lib/renderers/Form/Options', function(require, exports, module) {
  ...
  function registerOptionsControl(config) {
      ...
      var FormOptionsItem = /** @class */ (function (_super) {
          ...
          FormOptionsItem.prototype.deferLoad = function (option) {
              var _a;
              var _b = this.props, deferApi = _b.deferApi, source = _b.source, env = _b.env, formItem = _b.formItem, data = _b.data;
              if (option.loaded) {
                  return;
              }
              ...
              (_a = formItem) === null || _a === void 0 ? void 0 : _a.deferLoadOptions(option, api, helper_1.createObject(data, option));
          };
