define('node_modules/amis/lib/renderers/Form/File', function(require, exports, module) {
  ...
  // @ts-ignore
  var mapLimit_1 = tslib_1.__importDefault(require("node_modules/amis/node_modules/async/mapLimit"));
  var Image_1 = tslib_1.__importDefault(require("node_modules/amis/lib/renderers/Form/Image"));
  ...
  var FileControl = /** @class */ (function (_super) {
      ...
      FileControl.prototype.sendFile = function (file, cb, onProgress) {
          var _a = this.props, reciever = _a.reciever, fileField = _a.fileField, downloadUrl = _a.downloadUrl, useChunk = _a.useChunk, chunkSize = _a.chunkSize, startChunkApi = _a.startChunkApi, chunkApi = _a.chunkApi, finishChunkApi = _a.finishChunkApi, asBase64 = _a.asBase64, asBlob = _a.asBlob, data = _a.data, __ = _a.translate, multiple = _a.multiple, autoFill = _a.autoFill, onBulkChange = _a.onBulkChange;
          if (asBase64) {
          ...
          fn(file, reciever, {}, {
              ...
              var sendTo = !multiple &&
                  ...
                  tpl_builtin_1.dataMapping(autoFill, ret.data);
