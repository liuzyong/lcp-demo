define('node_modules/amis/lib/renderers/Form/RichText', function(require, exports, module) {
  ...
  var LazyComponent_1 = tslib_1.__importDefault(require("node_modules/amis/lib/components/LazyComponent"));
  ...
  function loadRichText(type) {
      ...
      return function () {
          return new Promise(function (resolve) {
              return type === 'tinymce'
                  ? require(['node_modules/amis/lib/components/Tinymce'], function (component) {
                      return resolve(component.default);
                  })
                  : require(['node_modules/amis/lib/components/RichText'], function (component) {
                      return resolve(component.default);
                  });
          });
      };
