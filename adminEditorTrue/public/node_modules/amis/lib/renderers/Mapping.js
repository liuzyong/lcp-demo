define('node_modules/amis/lib/renderers/Mapping', function(require, exports, module) {
  ...
  var MappingField = /** @class */ (function (_super) {
      ...
      MappingField.prototype.render = function () {
          ...
          if (typeof key !== 'undefined' && map && (_a = map[key], (_a !== null && _a !== void 0 ? _a : map['*']))) {
              viewValue = render('tpl', (_b = map[key], (_b !== null && _b !== void 0 ? _b : (key === true && map['1']
                  ? map['1']
                  : key === false && map['0']
                      ? map['0']
