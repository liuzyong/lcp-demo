define('node_modules/monaco-editor/esm/vs/editor/standalone/browser/accessibilityHelp/accessibilityHelp', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/standalone/browser/accessibilityHelp/accessibilityHelp.css*/;
  ...
  var toggleTabFocusMode_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/toggleTabFocusMode/toggleTabFocusMode");
  ...
  var CONTEXT_ACCESSIBILITY_WIDGET_VISIBLE = new contextkey_js_1.RawContextKey('accessibilityHelpWidgetVisible', false);
  ...
  function getSelectionLabel(selections, charactersSelected) {
      if (!selections || selections.length === 0) {
          return standaloneStrings_js_1.AccessibilityHelpNLS.noSelection;
      }
      if (selections.length === 1) {
          if (charactersSelected) {
              return strings.format(standaloneStrings_js_1.AccessibilityHelpNLS.singleSelectionRange, selections[0].positionLineNumber, selections[0].positionColumn, charactersSelected);
          }
          return strings.format(standaloneStrings_js_1.AccessibilityHelpNLS.singleSelection, selections[0].positionLineNumber, selections[0].positionColumn);
      }
      if (charactersSelected) {
          return strings.format(standaloneStrings_js_1.AccessibilityHelpNLS.multiSelectionRange, selections.length, charactersSelected);
      }
      if (selections.length > 0) {
          return strings.format(standaloneStrings_js_1.AccessibilityHelpNLS.multiSelection, selections.length);
      }
      return '';
  }
  var AccessibilityHelpWidget = /** @class */ (function (_super) {
      ...
      function AccessibilityHelpWidget(editor, _contextKeyService, _keybindingService, _openerService) {
          ...
          _this._contentDomNode = fastDomNode_js_1.createFastDomNode(document.createElement('div'));
          ...
          _this._register(dom.addStandardDisposableListener(_this._contentDomNode.domNode, 'keydown', function (e) {
              ...
              if (e.equals(2048 /* CtrlCmd */ | 35 /* KEY_E */)) {
                  aria_js_1.alert(standaloneStrings_js_1.AccessibilityHelpNLS.emergencyConfOn);
              ...
              if (e.equals(2048 /* CtrlCmd */ | 38 /* KEY_H */)) {
                  aria_js_1.alert(standaloneStrings_js_1.AccessibilityHelpNLS.openingDocs);
                  var url = _this._editor.getRawConfiguration().accessibilityHelpUrl;
                  if (typeof url === 'undefined') {
                      url = 'https://go.microsoft.com/fwlink/?linkid=852450';
                  }
                  _this._openerService.open(uri_js_1.URI.parse(url));
                  e.preventDefault();
                  e.stopPropagation();
              }
          }));
      ...
      AccessibilityHelpWidget.prototype._buildContent = function () {
          ...
          if (opts.wrappingInfo.inDiffEditor) {
              if (opts.readOnly) {
                  text += standaloneStrings_js_1.AccessibilityHelpNLS.readonlyDiffEditor;
              }
              else {
                  text += standaloneStrings_js_1.AccessibilityHelpNLS.editableDiffEditor;
              }
          }
          else {
              if (opts.readOnly) {
                  text += standaloneStrings_js_1.AccessibilityHelpNLS.readonlyEditor;
              }
              else {
                  text += standaloneStrings_js_1.AccessibilityHelpNLS.editableEditor;
              }
          }
          var turnOnMessage = (platform.isMacintosh
              ? standaloneStrings_js_1.AccessibilityHelpNLS.changeConfigToOnMac
              : standaloneStrings_js_1.AccessibilityHelpNLS.changeConfigToOnWinLinux);
          switch (opts.accessibilitySupport) {
              case 0 /* Unknown */:
                  text += '\n\n - ' + turnOnMessage;
                  break;
              case 2 /* Enabled */:
                  text += '\n\n - ' + standaloneStrings_js_1.AccessibilityHelpNLS.auto_on;
                  break;
              case 1 /* Disabled */:
                  text += '\n\n - ' + standaloneStrings_js_1.AccessibilityHelpNLS.auto_off;
                  text += ' ' + turnOnMessage;
                  break;
          }
          if (opts.tabFocusMode) {
              text += '\n\n - ' + this._descriptionForCommand(toggleTabFocusMode_js_1.ToggleTabFocusModeAction.ID, standaloneStrings_js_1.AccessibilityHelpNLS.tabFocusModeOnMsg, standaloneStrings_js_1.AccessibilityHelpNLS.tabFocusModeOnMsgNoKb);
          }
          else {
              text += '\n\n - ' + this._descriptionForCommand(toggleTabFocusMode_js_1.ToggleTabFocusModeAction.ID, standaloneStrings_js_1.AccessibilityHelpNLS.tabFocusModeOffMsg, standaloneStrings_js_1.AccessibilityHelpNLS.tabFocusModeOffMsgNoKb);
          }
          var openDocMessage = (platform.isMacintosh
              ? standaloneStrings_js_1.AccessibilityHelpNLS.openDocMac
              : standaloneStrings_js_1.AccessibilityHelpNLS.openDocWinLinux);
          text += '\n\n - ' + openDocMessage;
          text += '\n\n' + standaloneStrings_js_1.AccessibilityHelpNLS.outroMsg;
          this._contentDomNode.domNode.appendChild(htmlContentRenderer_js_1.renderFormattedText(text));
  ...
  var ShowAccessibilityHelpAction = /** @class */ (function (_super) {
      ...
      function ShowAccessibilityHelpAction() {
          return _super.call(this, {
              ...
              label: standaloneStrings_js_1.AccessibilityHelpNLS.showAccessibilityHelpAction,
  ...
  editorExtensions_js_1.registerEditorContribution(AccessibilityHelpController);
  editorExtensions_js_1.registerEditorAction(ShowAccessibilityHelpAction);
  var AccessibilityHelpCommand = editorExtensions_js_1.EditorCommand.bindToContribution(AccessibilityHelpController.get);
  editorExtensions_js_1.registerEditorCommand(new AccessibilityHelpCommand({
