define('node_modules/monaco-editor/esm/vs/editor/contrib/clipboard/clipboard', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/clipboard/clipboard.css*/;
  ...
  var ExecCommandCopyWithSyntaxHighlightingAction = /** @class */ (function (_super) {
      ...
      ExecCommandCopyWithSyntaxHighlightingAction.prototype.run = function (accessor, editor) {
          ...
          textAreaInput_js_1.CopyOptions.forceCopyWithSyntaxHighlighting = true;
          _super.prototype.run.call(this, accessor, editor);
          textAreaInput_js_1.CopyOptions.forceCopyWithSyntaxHighlighting = false;
      };
      return ExecCommandCopyWithSyntaxHighlightingAction;
  }(ExecCommandAction));
  if (supportsCut) {
      editorExtensions_js_1.registerEditorAction(ExecCommandCutAction);
  }
  if (supportsCopy) {
      editorExtensions_js_1.registerEditorAction(ExecCommandCopyAction);
  }
  if (supportsPaste) {
      editorExtensions_js_1.registerEditorAction(ExecCommandPasteAction);
  }
  if (supportsCopyWithSyntaxHighlighting) {
      editorExtensions_js_1.registerEditorAction(ExecCommandCopyWithSyntaxHighlightingAction);
  }
