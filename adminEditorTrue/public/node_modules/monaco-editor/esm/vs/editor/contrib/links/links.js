define('node_modules/monaco-editor/esm/vs/editor/contrib/links/links', function(require, exports, module) {
  ...
  ''/*@require node_modules/monaco-editor/esm/vs/editor/contrib/links/links.css*/;
  var nls = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/nls"));
  var async = tslib_1.__importStar(require("node_modules/monaco-editor/esm/vs/base/common/async"));
  ...
  var getLinks_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/links/getLinks");
  ...
  var HOVER_MESSAGE_GENERAL_META = new htmlContent_js_1.MarkdownString().appendText(platform.isMacintosh
      ? nls.localize('links.navigate.mac', "Cmd + click to follow link")
      : nls.localize('links.navigate', "Ctrl + click to follow link"));
  var HOVER_MESSAGE_COMMAND_META = new htmlContent_js_1.MarkdownString().appendText(platform.isMacintosh
      ? nls.localize('links.command.mac', "Cmd + click to execute command")
      : nls.localize('links.command', "Ctrl + click to execute command"));
  var HOVER_MESSAGE_GENERAL_ALT = new htmlContent_js_1.MarkdownString().appendText(platform.isMacintosh
      ? nls.localize('links.navigate.al.mac', "Option + click to follow link")
      : nls.localize('links.navigate.al', "Alt + click to follow link"));
  var HOVER_MESSAGE_COMMAND_ALT = new htmlContent_js_1.MarkdownString().appendText(platform.isMacintosh
  ...
  var decoration = {
      meta: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link',
          hoverMessage: HOVER_MESSAGE_GENERAL_META
      }),
      metaActive: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link-active',
          hoverMessage: HOVER_MESSAGE_GENERAL_META
      }),
      alt: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link',
          hoverMessage: HOVER_MESSAGE_GENERAL_ALT
      }),
      altActive: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link-active',
          hoverMessage: HOVER_MESSAGE_GENERAL_ALT
      }),
      altCommand: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link',
          hoverMessage: HOVER_MESSAGE_COMMAND_ALT
      }),
      altCommandActive: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link-active',
          hoverMessage: HOVER_MESSAGE_COMMAND_ALT
      }),
      metaCommand: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link',
          hoverMessage: HOVER_MESSAGE_COMMAND_META
      }),
      metaCommandActive: textModel_js_1.ModelDecorationOptions.register({
          stickiness: 1 /* NeverGrowsWhenTypingAtEdges */,
          collapseOnReplaceEdit: true,
          inlineClassName: 'detected-link-active',
          hoverMessage: HOVER_MESSAGE_COMMAND_META
  ...
  var LinkDetector = /** @class */ (function () {
      function LinkDetector(editor, openerService, notificationService) {
          ...
          var clickLinkGesture = new clickLinkGesture_js_1.ClickLinkGesture(editor);
          ...
          this.listenersToRemove.push(modes_js_1.LinkProviderRegistry.onDidChange(function (e) { return _this.onModelModeChanged(); }));
              ...
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      case 0:
                          ...
                          if (!modes_js_1.LinkProviderRegistry.has(model)) {
                              return [2 /*return*/];
                          }
                          ...
                          this.computePromise = async.createCancelablePromise(function (token) { return getLinks_js_1.getLinks(model, token); });
                          _b.label = 1;
                      case 1:
                      ...
                      case 3:
                          err_1 = _b.sent();
                          errors_js_1.onUnexpectedError(err_1);
                          return [3 /*break*/, 5];
                      case 4:
                          this.computePromise = null;
                          return [7 /*endfinally*/];
      ...
      LinkDetector.prototype.openLinkOccurrence = function (occurrence, openToSide) {
          ...
          link.resolve(cancellation_js_1.CancellationToken.None).then(function (uri) {
              // open the uri
      ...
      LinkDetector.prototype.dispose = function () {
          this.listenersToRemove = lifecycle_js_1.dispose(this.listenersToRemove);
          this.stop();
  ...
  editorExtensions_js_1.registerEditorContribution(LinkDetector);
  editorExtensions_js_1.registerEditorAction(OpenLinkAction);
