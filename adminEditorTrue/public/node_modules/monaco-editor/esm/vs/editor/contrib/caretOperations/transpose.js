define('node_modules/monaco-editor/esm/vs/editor/contrib/caretOperations/transpose', function(require, exports, module) {
  ...
  var TransposeLettersAction = /** @class */ (function (_super) {
      ...
      TransposeLettersAction.prototype.positionLeftOf = function (start, model) {
          ...
          if (column > model.getLineMinColumn(lineNumber)) {
              if (strings_js_1.isLowSurrogate(model.getLineContent(lineNumber).charCodeAt(column - 2))) {
      ...
      TransposeLettersAction.prototype.positionRightOf = function (start, model) {
          ...
          if (column < model.getLineMaxColumn(lineNumber)) {
              if (strings_js_1.isHighSurrogate(model.getLineContent(lineNumber).charCodeAt(column - 1))) {
      ...
      TransposeLettersAction.prototype.run = function (accessor, editor) {
          ...
          for (var _i = 0, selections_1 = selections; _i < selections_1.length; _i++) {
              ...
              var leftChar = model.getValueInRange(range_js_1.Range.fromPositions(beginPosition, middlePosition));
              var rightChar = model.getValueInRange(range_js_1.Range.fromPositions(middlePosition, endPosition));
              var replaceRange = range_js_1.Range.fromPositions(beginPosition, endPosition);
  ...
  editorExtensions_js_1.registerEditorAction(TransposeLettersAction);
