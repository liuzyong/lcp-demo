define('node_modules/monaco-editor/esm/vs/editor/contrib/format/formatActions', function(require, exports, module) {
  ...
  var format_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/format/format");
  ...
  var FormatOnType = /** @class */ (function () {
      function FormatOnType(editor, _workerService) {
          ...
          this._callOnDispose.push(modes_js_1.OnTypeFormattingEditProviderRegistry.onDidChange(this._update, this));
      }
      ...
      FormatOnType.prototype.dispose = function () {
          ...
          this._callOnModel = lifecycle_js_1.dispose(this._callOnModel);
      };
      FormatOnType.prototype._update = function () {
          ...
          // no support
          var support = modes_js_1.OnTypeFormattingEditProviderRegistry.ordered(model)[0];
          if (!support || !support.autoFormatTriggerCharacters) {
              return;
          }
          // register typing listeners that will trigger the format
          var triggerChars = new characterClassifier_js_1.CharacterSet();
      ...
      FormatOnType.prototype._trigger = function (ch) {
          ...
          format_js_1.getOnTypeFormattingEdits(this._workerService, model, position, ch, model.getFormattingOptions()).then(function (edits) {
              unbind.dispose();
              if (canceled) {
                  return;
              }
              if (arrays_js_1.isNonEmptyArray(edits)) {
                  formattingEdit_js_1.FormattingEdit.execute(_this._editor, edits);
                  format_js_1.alertFormattingEdits(edits);
              }
          }, function (err) {
              unbind.dispose();
              throw err;
  ...
  var FormatOnPaste = /** @class */ (function () {
      function FormatOnPaste(editor, _instantiationService) {
          ...
          this._callOnDispose.push(editor.onDidChangeModel(function () { return _this._update(); }));
          this._callOnDispose.push(editor.onDidChangeModelLanguage(function () { return _this._update(); }));
          this._callOnDispose.push(modes_js_1.DocumentRangeFormattingEditProviderRegistry.onDidChange(this._update, this));
      }
      ...
      FormatOnPaste.prototype._update = function () {
          ...
          // no formatter
          if (!modes_js_1.DocumentRangeFormattingEditProviderRegistry.has(this.editor.getModel())) {
              return;
          }
      ...
      FormatOnPaste.prototype._trigger = function (range) {
          ...
          this._instantiationService.invokeFunction(format_js_1.formatDocumentRangeWithSelectedProvider, this.editor, range, 2 /* Silent */, cancellation_js_1.CancellationToken.None).catch(errors_js_1.onUnexpectedError);
      };
  ...
  var FormatDocumentAction = /** @class */ (function (_super) {
      ...
      function FormatDocumentAction() {
          return _super.call(this, {
              ...
              precondition: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.writable, editorContextKeys_js_1.EditorContextKeys.hasDocumentFormattingProvider),
              kbOpts: {
                  kbExpr: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.editorTextFocus, editorContextKeys_js_1.EditorContextKeys.hasDocumentFormattingProvider),
                  primary: 1024 /* Shift */ | 512 /* Alt */ | 36 /* KEY_F */,
                  linux: { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 39 /* KEY_I */ },
                  weight: 100 /* EditorContrib */
              },
              menuOpts: {
                  when: editorContextKeys_js_1.EditorContextKeys.hasDocumentFormattingProvider,
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          ...
                          return [4 /*yield*/, instaService.invokeFunction(format_js_1.formatDocumentWithSelectedProvider, editor, 1 /* Explicit */, cancellation_js_1.CancellationToken.None)];
                      case 1:
                          _a.sent();
                          _a.label = 2;
  ...
  var FormatSelectionAction = /** @class */ (function (_super) {
      ...
      function FormatSelectionAction() {
          return _super.call(this, {
              ...
              alias: 'Format Code',
              precondition: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.writable, editorContextKeys_js_1.EditorContextKeys.hasDocumentSelectionFormattingProvider),
              kbOpts: {
                  kbExpr: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.editorTextFocus, editorContextKeys_js_1.EditorContextKeys.hasDocumentSelectionFormattingProvider),
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 36 /* KEY_F */),
                  weight: 100 /* EditorContrib */
              },
              menuOpts: {
                  when: contextkey_js_1.ContextKeyExpr.and(editorContextKeys_js_1.EditorContextKeys.hasDocumentSelectionFormattingProvider, editorContextKeys_js_1.EditorContextKeys.hasNonEmptySelection),
                  group: '1_modification',
                  order: 1.31
              }
          }) || this;
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          ...
                          if (range.isEmpty()) {
                              range = new range_js_1.Range(range.startLineNumber, 1, range.startLineNumber, model.getLineMaxColumn(range.startLineNumber));
                          }
                          return [4 /*yield*/, instaService.invokeFunction(format_js_1.formatDocumentRangeWithSelectedProvider, editor, range, 1 /* Explicit */, cancellation_js_1.CancellationToken.None)];
                      case 1:
                          _a.sent();
                          return [2 /*return*/];
                  }
  ...
  editorExtensions_js_1.registerEditorContribution(FormatOnType);
  editorExtensions_js_1.registerEditorContribution(FormatOnPaste);
  editorExtensions_js_1.registerEditorAction(FormatDocumentAction);
  editorExtensions_js_1.registerEditorAction(FormatSelectionAction);
  // this is the old format action that does both (format document OR format selection)
  // and we keep it here such that existing keybinding configurations etc will still work
  commands_js_1.CommandsRegistry.registerCommand('editor.action.format', function (accessor) {
      return __awaiter(_this, void 0, void 0, function () {
          var editor, commandService;
          return __generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      editor = accessor.get(codeEditorService_js_1.ICodeEditorService).getFocusedCodeEditor();
                      if (!editor || !editor.hasModel()) {
                          return [2 /*return*/];
                      }
                      commandService = accessor.get(commands_js_1.ICommandService);
