define('node_modules/monaco-editor/esm/vs/editor/contrib/comment/comment', function(require, exports, module) {
  ...
  var lineCommentCommand_js_1 = require("node_modules/monaco-editor/esm/vs/editor/contrib/comment/lineCommentCommand");
  var CommentLineAction = /** @class */ (function (_super) {
      ...
      CommentLineAction.prototype.run = function (accessor, editor) {
          ...
          for (var _i = 0, selections_1 = selections; _i < selections_1.length; _i++) {
              ...
              commands.push(new lineCommentCommand_js_1.LineCommentCommand(selection, opts.tabSize, this._type));
          }
          editor.pushUndoStop();
  ...
  var AddLineCommentAction = /** @class */ (function (_super) {
      ...
      function AddLineCommentAction() {
          return _super.call(this, 1 /* ForceAdd */, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 33 /* KEY_C */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
  ...
  var RemoveLineCommentAction = /** @class */ (function (_super) {
      ...
      function RemoveLineCommentAction() {
          return _super.call(this, 2 /* ForceRemove */, {
              ...
              kbOpts: {
                  kbExpr: editorContextKeys_js_1.EditorContextKeys.editorTextFocus,
                  primary: keyCodes_js_1.KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 51 /* KEY_U */),
                  weight: 100 /* EditorContrib */
              }
          }) || this;
      }
  ...
  var BlockCommentAction = /** @class */ (function (_super) {
      ...
      BlockCommentAction.prototype.run = function (accessor, editor) {
          ...
          for (var _i = 0, selections_2 = selections; _i < selections_2.length; _i++) {
              ...
              commands.push(new blockCommentCommand_js_1.BlockCommentCommand(selection));
          }
          editor.pushUndoStop();
          editor.executeCommands(this.id, commands);
          editor.pushUndoStop();
  ...
  editorExtensions_js_1.registerEditorAction(ToggleCommentLineAction);
  editorExtensions_js_1.registerEditorAction(AddLineCommentAction);
  editorExtensions_js_1.registerEditorAction(RemoveLineCommentAction);
  editorExtensions_js_1.registerEditorAction(BlockCommentAction);
