define('route/Preview.tsx', function(require, exports, module) {
  ...
  var EditPageModal_1 = tslib_1.__importDefault(require("component/EditPageModal.tsx"));
  ...
  function getPageMassge(store, id) {
  }
  exports.default = mobx_react_1.inject('store')(mobx_react_1.observer(function (_a) {
          ...
          return (react_1.default.createElement("div", null,
              react_1.default.createElement("div", { className: "a-Layout-brandBar" },
                  ...
                  react_1.default.createElement("div", { className: "a-Layout-brand" },
                      ...
                      react_1.default.createElement("span", { className: "hidden-folded m-l-sm" }, "Admin "))),
              react_1.default.createElement("div", { className: "a-Layout-headerBar" },
                  ...
                  react_1.default.createElement("div", { className: "hidden-xs p-t-sm pull-right" },
                      react_1.default.createElement(amis_1.Button, { size: "sm", className: "m-r-xs", level: "success", disabledTip: "Todo..." }, "\u4FDD\u5B58\u5E94\u7528"),
                      react_1.default.createElement(amis_1.Button, { size: "sm", className: "m-r-xs", level: "error", disabledTip: "Todo..." }, "\u5386\u53F2\u7248\u672C"),
      ...
      function renderAside() {
          ...
          return (react_1.default.createElement(amis_1.AsideNav, { key: store.asideFolded ? 'folded-aside' : 'aside', navigations: [
                  ...
                  children.push(react_1.default.createElement("i", { key: "edit", "data-tooltip": "\u7F16\u8F91\u9875\u9762", "data-position": "bottom", className: 'navbtn fa fa-pencil', onClick: function (e) {
                          e.preventDefault();
                          history.push("/edit/" + paths.indexOf(link.path));
                      } }));
                  children.push(react_1.default.createElement("i", { key: "editNav", "data-tooltip": "\u7F16\u8F91\u5BFC\u822A", "data-position": "bottom", className: 'navbtn  fa fa-list-ol', onClick: function () { return store.setEditPageIsOpen(true); } }));
      ...
      function handleEditConfirm(value) {
          store.editPage(tslib_1.__assign(tslib_1.__assign({}, value), { schema: {
                  type: 'page',
                  title: value.label,
                  body: '这是你刚刚新增的页面。'
              } }));
      ...
      return (react_1.default.createElement(amis_1.Layout, { aside: renderAside(), header: renderHeader(), folded: store.asideFolded, offScreen: store.offScreen },
          ...
          react_1.default.createElement(EditPageModal_1.default, { show: store.editPageIsOpen, onClose: function () { return store.setEditPageIsOpen(false); }, onConfirm: handleEditConfirm, pages: store.pages.concat() })));
  }));
